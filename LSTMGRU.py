...
def lstmgru(trainDataGroups, validateDataGroups, testDataGroups):
    future_range = 7
    past_range = 28
...
def train_lstm(x_train, y_train, x_validate, y_validate, future_range, y_scale, y_test, x_test):
    ...
    lstm_model = tf.keras.models.Sequential([
        GRU(200, return_sequences=True, input_shape=x_train.shape[-2:]),
        GRU(200),
    ...
    model_path = 'Models/GRU_Multivariate.h5'
...
def timeseries_evaluation_metrics_func(y_true, y_pred):
    ...
    f = open("ResultsTXT/resultadosGRU.txt", "a")
